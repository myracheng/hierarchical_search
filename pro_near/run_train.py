"""
python3.8 run_train.py --algorithm enumeration --exp_name mars_an --trial 1 \
...
--class_weights "0.3,0.7" --max_num_programs 5
"""
import argparse
import os
import pickle
...
if __name__ == '__main__':
    ...
    train_features, train_labels = preprocess(train_raw_features, train_raw_annotations, args.train_labels, behave_dict)
    test_features, test_labels = preprocess(test_raw_features, test_raw_annotations, args.train_labels, behave_dict)
    if valid_raw_features is not None and valid_raw_annotations is not None:
        valid_features, valid_labels = preprocess(valid_raw_features, valid_raw_annotations, train_labels, behave_dict)
