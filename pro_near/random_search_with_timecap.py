...
"""
Sample command:
python3.8 random_search_with_timecap.py --algorithm astar-near --exp_name mars_an --trial 1 \
...
--class_weights "0.3,0.7" --batch_size 128
...
class Subtree_search():
    ...
    def __init__(self, base_prog, **kwargs):
        self.base_program_name = base_prog
    ...
    def run_near(self): 
        ...
        if self.device == 'cpu':
            ...
            base_program = pickle.load(open("%s" % self.base_program_name, "rb"))['program']
...
if __name__ == '__main__':
    ...
    for base_prog in glob.glob('../near_code_7keypoints/results/mars_baby_an_enumeration_001/**.p'): #TODO
        print(base_prog)
        search_instance = Subtree_search(base_prog, **vars(args))
