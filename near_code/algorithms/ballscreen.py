...
class BALLSCREEN(ProgramLearningAlgorithm):
    ...
    def run(self, graph, trainset, validset, train_config, device, verbose=False):
        ...
        log_and_print("Training child program: {}".format(print_program(child_node[0].program, ignore_constants=(not verbose))))
        ...
        score = execute_and_train(child_node[0].program, validset, trainset, train_config, 
