...
from graph_reader import read_2cols_set_files, create_numeric_classes,divide_datasets_leave_one_out
...
parser.add_argument('--logPath', default='../log/f/duvenaud_classification/', help='log path')
...
def main():
    ...
    train_ids, train_classes, valid_ids, valid_classes, test_ids, test_classes = divide_datasets_leave_one_out(files, classes,args.batch_size)
...
def validate(val_loader, model, criterion, evaluation, logger=None):
    ...
    for i, (g, h, e, target) in enumerate(val_loader):
        ...
        # if utils.get_inaccurate(output.data,target.data):
        #     print("Inacc")
        #     print(g)
        #     print(h)
        acc = Variable(evaluation(output.data, target.data, topk=(1,))[0])
